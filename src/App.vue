<template>
  <div id="app">
    <div class="container" style="width: 1500px">
			...
			<img class="pageBanner" src="https://cdn.pixabay.com/photo/2017/12/17/12/45/football-3024154_960_720.jpg"  >
			</div>
      <div class="" style="margin-top:20px">
        <h1>Welcome</h1> <br>
...
var config = {
  apiKey: 'AIzaSyDWfGGGoegwJsKBN3Ete_yYxD1CMBw0Pes',
  authDomain: 'testfirebaserules.firebaseapp.com',
  databaseURL: 'https://testfirebaserules.firebaseio.com',
  projectId: 'testfirebaserules',
  storageBucket: 'testfirebaserules.appspot.com',
  messagingSenderId: '539751636639'
}
